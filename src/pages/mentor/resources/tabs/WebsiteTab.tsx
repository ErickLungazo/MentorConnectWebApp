...
const WebsiteTab = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast.success("Website resource added successfully!");
      setTrainingSourceUrl(data.sourceUrl);
    } catch (error) {
      console.error("Error saving website resource:", error);
          ...
          <Form {...form}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Website Name or Description</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Enter website name or description"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
